...
const TRACE: RunTrace = {
  ...
  stats: { duration_ms: 8200, tokens_in: 12000, tokens_out: 1500, cost_usd: 0.0412, findings: 2, grounding: "2/2 passed" },
...
describe("A5 Run Trace drawer (smoke)", () => {
  ...
  it("shows what the run cost alongside duration and tokens", () => {
    renderWithIntl(<RunTraceDrawer runId="r1" agentName="Security" prNumber={482} onClose={() => {}} />);
